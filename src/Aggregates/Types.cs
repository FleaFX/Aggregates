...
public delegate void EventSerializerDelegate(Stream destination, object @event);

/// <summary>
/// Deserializes the given binary serialized event.
/// </summary>
/// <param name="source">The <see cref="Stream"/> to read the serialized event from.</param>
/// <param name="target">The target type to deserialize to.</param>
/// <returns>A <see cref="object"/>.</returns>
delegate object EventDeserializerDelegate(Stream source, Type target);
