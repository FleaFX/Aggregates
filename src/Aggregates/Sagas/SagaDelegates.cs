...
public delegate IAsyncEnumerable<TCommand> SagaAsyncDelegate<in TSagaState, in TSagaEvent, out TCommand, TState, TEvent>(TSagaState state, TSagaEvent @event, IReadOnlyDictionary<string, object?>? metadata = null, [EnumeratorCancellation] CancellationToken cancellationToken = default)
